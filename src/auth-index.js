// --------------------------------------------------------------------- //
// An alternative app that only shows public pages 											 //
// These pages do not require authentication 														 //
// The contents of this file should be moved to index.js before building //
// --------------------------------------------------------------------- //
...
/**	
 * React Containers
 * @import LandingContainer the container component connecting the landing page 
 *													to its state
